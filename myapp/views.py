...
def add_product(request):
    if request.method == 'POST':
        ...
        product = Product(name=name, price=price, image=image, seller_name=seller_name)
        product.save()
...
def create_checkout_session(request, id):
    ...
    checkout_session = stripe.checkout.Session.create(
        ...
        mode = 'payment',
        success_url = request.build_absolute_uri(reverse('myapp:success'))+"?session_id={CHECHOUT_SESSION_ID}",
